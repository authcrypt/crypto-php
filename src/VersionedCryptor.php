...
final readonly class VersionedCryptor implements CryptorInterface
{
    ...
    public function encrypt(
        ...
        $payload = $this->cryptors[$this->currentVersion]->encrypt($data, $context);
    ...
    public function decrypt(
        ...
        $version = StringHelper::byteSubstr($data, 0, $this->versionSize);
        ...
        $payload = StringHelper::byteSubstr($data, $this->versionSize);

        return $cryptor->decrypt($payload, $context);
    }
