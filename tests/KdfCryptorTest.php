...
final class KdfCryptorTest extends TestCase
{
    ...
    public function testEncryptProducesExpectedStructure(
        ...
        $cryptor = new KdfCryptor(secret: $secret, kdf: $kdf, cipher: $cipher);
        ...
        $keySalt = StringHelper::byteSubstr($result, 0, $kdfSaltSize);
        $nonce = StringHelper::byteSubstr($result, $kdfSaltSize, $nonceSize);
        $ciphertext = StringHelper::byteSubstr($result, $kdfSaltSize + $nonceSize);
    ...
    public function testEncryptionIsRandomized(
        ...
        if ($kdfSaltSize > 0) {
            $salt1 = StringHelper::byteSubstr($res1, 0, $kdfSaltSize);
            $salt2 = StringHelper::byteSubstr($res2, 0, $kdfSaltSize);
        ...
        if ($nonceSize > 0) {
            $nonce1 = StringHelper::byteSubstr($res1, $kdfSaltSize, $nonceSize);
            $nonce2 = StringHelper::byteSubstr($res2, $kdfSaltSize, $nonceSize);
